...
#define DT_bounce 500		// Tempo entre dois clicks
...
volatile uint32_t prox_bounce = 0;	// Próximo tempo entre dois clicks

void EXTI9_5_IRQHandler(void)
{
	if (EXTI_GetITStatus(EXTI_Line6)!=RESET && millis()>= prox_bounce)
	{
